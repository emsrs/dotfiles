...
static int tagindicatortype =
    INDICATOR_BOTTOM_BAR_SLIM; // see patch/bar_indicators.h for options
static int floatindicatortype =
    INDICATOR_TOP_LEFT_SQUARE; // see patch/bar_indicators.h for options
...
const char *spcmd2[] = {"st",     "-n", "spotify", "-g",
                        "110x30", "-e", "spt",     NULL};
const char *spcmd3[] = {"st",     "-n", "spmusic", "-g",
                        "110x30", "-e", "ncmpcpp", NULL};
    ...
    RULE(.class = "feh", .isfloating = 1,
        ...
        RULE(.wintype = WTYPE "UTILITY",
             .isfloating = 0) RULE(.wintype = WTYPE "TOOLBAR",
                                   .isfloating = 0) RULE(.wintype =
                                                             WTYPE "SPLASH",
                                                         .isfloating = 0)
            RULE(.class = "Firefox", .tags = 1 << 1, .monitor = 0) RULE(
                    .class = "tabbed", .tags = 1 << 1,
                    .monitor = 0) RULE(.class = "Surf", .tags = 0, .monitor = 0,
                                       .iscentered = 1, .isfloating = 1,
                                       .floatpos =
                                           "1596W 904H")
                RULE(
                        .title =
                        ...
                        .tags =
                            1 << 8,
                        .monitor = 0) RULE(.title = "neomutt", .tags = 1 << 8,
                                           .monitor = 0)
                    RULE(.title = "weechat", .tags = 1 << 3, .monitor = 0) RULE(
                            .title =
                                "youtube-viewer",
                            .tags =
                                1 << 6,
                            .monitor = 0) RULE(.title = "spt", .tags = 1 << 7,
                                               .monitor = 0) RULE(.title =
                                                                      "finchy",
                                                                  .tags = 1 << 2,
                                                                  .monitor = 0)
                        RULE(.class = "Hexchat", .tags = 1 << 3, .monitor = 0) RULE(
                                .class =
                                    "Pidgin",
                                .tags =
                                    1 << 2,
                                .monitor = 0)
                            RULE(.title = "finchy", .tags = 1 << 2,
                                 .monitor =
                                     0) RULE(.class = "Thunar", .tags = 1 << 4)
                                RULE(.class = "Gimp", .tags = 1 << 5) RULE(
                                        .class =
                                            "vlc",
                                        .tags =
                                            1 << 6,
 ...
 * clickfunc                name */
    ...
    {-1, 0, BAR_ALIGN_RIGHT, width_status2d, draw_status2d, click_statuscmd,
     "status2d"},
#elif BAR_STATUS2D_PATCH
    {-1, 0, BAR_ALIGN_RIGHT, width_status2d, draw_status2d, click_status2d,
     "status2d"},
...
static const Layout layouts[] = {
    /* symbol     arrange function, { nmaster, nstack, layout, master axis,
       stack axis, secondary stack axis } */
    {"",
     flextile,
     {-1, -1, NO_SPLIT, DWINDLE, 0, 0, NULL}}, // fibonacci dwindle 
    {"",
     flextile,
     {-1, -1, SPLIT_CENTERED_VERTICAL, TOP_TO_BOTTOM, TOP_TO_BOTTOM,
      TOP_TO_BOTTOM, NULL}}, // centeredmast>
    ...
    {"",
     flextile,
     {-1, -1, NO_SPLIT, GAPPLESSGRID, 0, 0, NULL}},          // gappless grid
...
static const char *rofi[] = {"rofi",        "-combi-modi", "drun,run,ssh",
                             "-theme",      "slate",       "-font",
                             "hack 10",     "-show",       "combi",
...
static const char *mpcnxt[] = {"mpc", "-h", "/usr/home/cjg/.mpd/socket", "next",
                               NULL};
static const char *mpctgl[] = {"mpc", "-h", "/usr/home/cjg/.mpd/socket",
                               "toggle", NULL};
static const char *mpcstp[] = {"mpc", "-h", "/usr/home/cjg/.mpd/socket", "stop",
                               NULL};
static const char *mpcprv[] = {"mpc", "-h", "/usr/home/cjg/.mpd/socket", "prev",
                               NULL};
...
static const char *brightnessup[] = {"/home/cjg/bin/brightnessControl.sh", "up",
                                     NULL};
static const char *brightnessdown[] = {"/home/cjg/bin/brightnessControl.sh",
                                       "down", NULL};
 ...
 */
    ...
    {MODKEY, XK_x, spawn, {.v = hexchat}}, {MODKEY, XK_e, spawn, {.v = emoji}},
    ...
    {NULL, 0xffc0, spawn, {.v = upvol}}, {NULL, 0xffc0, spawn, {.v = updstat}},
    {NULL, 0xffbf, spawn, {.v = downvol}},
    {NULL, 0xffbf, spawn, {.v = updstat}}, {NULL, XK_F1, spawn, {.v = mutevol}},
    ...
    {NULL, XK_F12, layoutmenu, {0}}, {NULL, XK_Print, spawn, {.v = screenshot}},
    ...
    {MODKEY,
     X66 = F13'  K_y,          togglefullscreen,       {0} },
	...
	{ MODKEY|ShiftMask,             XK_0,          tag,                    {.ui = ~0 } },
      ...
      * defined with a Mod3Mask,
      * which is not always readily available. Refer to the patch wiki for more
      * details. */
